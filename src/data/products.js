...
export const products = [
  {
    ...
    weightDetail: '250 ml bottle — easy starter size for tea, toast, and travel.',
    storage: 'Store tightly closed in a cool, dry place away from direct sunlight. Natural crystallization may occur.',
    usageIdeas: ['Sweeten tea, sobolo, or warm drinks', 'Drizzle over oats, bread, pancakes, or fruit', 'Use in marinades and homemade dressings'],
    goodFor: ['First-time honey buyers', 'Small households', 'Gifting or travel'],
    originalPrice: 8.99,
    salePrice: null,
    image: honey250Img,
  ...
  },
  {
    ...
    storage: 'Store tightly closed in a cool, dry place away from direct sunlight. Natural crystallization may occur.',
    usageIdeas: ['Sweeten tea, porridge, or smoothies', 'Drizzle over breakfast bowls', 'Use in sauces, marinades, and baking'],
    goodFor: ['Everyday family use', 'Breakfast routines', 'Natural sweetener replacement'],
    originalPrice: 14.99,
    salePrice: null,
    image: honey500Img,
  ...
  },
  {
    ...
    storage: 'Store tightly closed in a cool, dry place away from direct sunlight. Natural crystallization may occur.',
    usageIdeas: ['Daily tea and breakfast sweetener', 'Cooking, baking, and marinades', 'Pair with tombrown or oats'],
  ...
  },
  {
    ...
    ingredients: ['Pure wild honey'],
    weightDetail: '2 litre container — bulk value for homes, offices, and food prep.',
    storage: 'Store tightly closed in a cool, dry place away from direct sunlight. Natural crystallization may occur.',
    usageIdeas: ['Bulk sweetener for drinks and meals', 'Baking, sauces, and marinades', 'Refill smaller kitchen bottles'],
  ...
  },
  {
    ...
    weightDetail: 'Large bucket — value pack for family cooking and frequent use.',
    storage: 'Keep sealed after opening. Store in a cool, dry place and stir before use if natural oil separation appears.',
    usageIdeas: ['Use for groundnut soup and stews', 'Spread on bread or toast', 'Add to sauces, dips, and porridges'],
    goodFor: ['Groundnut soup lovers', 'Family meal prep', 'Bulk pantry stocking'],
    originalPrice: 29.99,
    salePrice: null,
    image: pbBucketImg,
  ...
  },
  {
    ...
    sizeKey: 'Pack',
    descKey: 'Nutritious tom brown porridge blend with millet, soya, rice, wheat, groundnut and yellow corn.',
    ingredients: ['Millet', 'Soya beans', 'Rice', 'Wheat', 'Groundnut', 'Yellow corn'],
    weightDetail: 'Pack size — convenient porridge blend for breakfast and quick meals.',
    storage: 'Keep sealed in an airtight container after opening. Store in a cool, dry place away from moisture.',
    usageIdeas: ['Prepare as warm breakfast porridge', 'Sweeten with honey or milk', 'Use as a filling family breakfast option'],
  ...
  },
  {
    ...
    storage: 'Keep sealed in an airtight container after opening. Store in a cool, dry place away from moisture.',
    usageIdeas: ['Prepare as tom brown porridge', 'Serve with honey, milk, or sugar', 'Batch-cook for family breakfast'],
  ...
  },
  {
    ...
    storage: 'Keep sealed in an airtight container after opening. Store in a cool, dry place away from moisture.',
    usageIdeas: ['Prepare family-size tom brown porridge', 'Pair with honey for a natural sweetener', 'Keep as a long-lasting breakfast staple'],
  ...
  },
  {
    ...
    storage: 'Keep dry and sealed after opening. Store away from moisture and strong odors.',
    usageIdeas: ['Prepare koko or porridge', 'Use for banku mixtures', 'Stock up for traditional family meals'],
    goodFor: ['Frequent cooking', 'Traditional Ghanaian meals', 'Family pantry stocking'],
    originalPrice: 12.99,
    salePrice: null,
